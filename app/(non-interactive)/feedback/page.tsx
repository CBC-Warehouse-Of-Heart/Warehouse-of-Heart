      ...
      <form action="http://localhost:3000/" method="post">
        <div className="mx-auto flex h-screen w-[390px]  flex-col items-center justify-start">
          ...
          <div className="z-10 mt-6 flex w-full justify-between px-14">
            <Button
              ...
              className={`h-[32px] w-[40px] rounded p-0 hover:bg-woh-white ${
                score === 1 || score === 0 ? "bg-woh-white" : "bg-gray"
              }`}
              onClick={(e) => {
                e.preventDefault();
            ...
            >
              ...
              >
                <path
                  ...
                  stroke={score === 1 || score === 0 ? "#C41C11" : "#C5C5C5"}
                  strokeWidth="2"
                  strokeLinecap="round"
            ...
            <Button
              size="sm"
              id="score-2"
              className={`hover:bg-woh-whit h-[32px] w-[40px] rounded p-0 ${
                score === 2 || score === 0 ? "bg-woh-white" : "bg-gray"
              }`}
              onClick={(e) => {
                e.preventDefault();
                setScore((prev) => (prev === 2 ? 0 : 2));
              }}
            >
              <svg
                width="25"
              ...
              >
                <path
                  d="M12.5132 22.2121C18.1777 22.2121 22.7697 17.8706 22.7697 12.5151C22.7697 7.15966 18.1777 2.81818 12.5132 2.81818C6.84879 2.81818 2.25684 7.15966 2.25684 12.5151C2.25684 17.8706 6.84879 22.2121 12.5132 22.2121Z"
                  stroke={score === 2 || score === 0 ? "#F1812F" : "#C5C5C5"}
                  stroke-width="2"
            ...
            <Button
              ...
              id="score-3"
              className={`h-[32px] w-[40px] rounded p-0 hover:bg-woh-white ${
                score === 3 || score === 0 ? "bg-woh-white" : "bg-gray"
              }`}
              onClick={(e) => {
                e.preventDefault();
                setScore((prev) => (prev === 3 ? 0 : 3));
              }}
            >
              <svg
                width="25"
              ...
              >
                <path
                  d="M12.5132 22.2121C18.1777 22.2121 22.7697 17.8706 22.7697 12.5151C22.7697 7.15966 18.1777 2.81818 12.5132 2.81818C6.84879 2.81818 2.25684 7.15966 2.25684 12.5151C2.25684 17.8706 6.84879 22.2121 12.5132 22.2121Z"
                  stroke={score === 3 || score === 0 ? "#F7D210" : "#C5C5C5"}
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
            ...
            <Button
              ...
              id="score-4"
              className={`h-[32px] w-[40px] rounded p-0 hover:bg-woh-white ${
                score === 4 || score === 0 ? "bg-woh-white" : "bg-gray"
              }`}
              onClick={(e) => {
                e.preventDefault();
                setScore((prev) => (prev === 4 ? 0 : 4));
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  d="M12.5132 22.2121C18.1777 22.2121 22.7697 17.8706 22.7697 12.5151C22.7697 7.15966 18.1777 2.81818 12.5132 2.81818C6.84879 2.81818 2.25684 7.15966 2.25684 12.5151C2.25684 17.8706 6.84879 22.2121 12.5132 22.2121Z"
                  stroke={score === 4 || score === 0 ? "#91D936" : "#C5C5C5"}
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
            ...
            <Button
              ...
              id="score-5"
              className={`h-[32px] w-[40px] rounded p-0 hover:bg-woh-white ${
                score === 5 || score === 0 ? "bg-woh-white" : "bg-gray"
              }`}
              onClick={(e) => {
                e.preventDefault();
                setScore((prev) => (prev === 5 ? 0 : 5));
              }}
            >
              <svg
                width="25"
              ...
              >
                <path
                  d="M12.5132 22.2121C18.1777 22.2121 22.7697 17.8706 22.7697 12.5151C22.7697 7.15966 18.1777 2.81818 12.5132 2.81818C6.84879 2.81818 2.25684 7.15966 2.25684 12.5151C2.25684 17.8706 6.84879 22.2121 12.5132 22.2121Z"
                  stroke={score === 5 || score === 0 ? "#3FC411" : "#C5C5C5"}
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                ...
                <path
                  ...
                  fill={score === 5 || score === 0 ? "#3FC411" : "#C5C5C5"}
                />
              </svg>
            </Button>
          </div>
          ...
          <div className="z-10 mt-[20px] text-center">
            <Button size="sm" className=" h-[50px] w-[282px]" type="submit">

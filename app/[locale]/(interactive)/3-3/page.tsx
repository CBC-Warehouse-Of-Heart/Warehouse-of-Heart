      ...
      >
        ...
        <div className="flex h-[120px] w-[360px] flex-col items-center justify-center">
          <div className="text-center text-base font-normal text-zinc-900 ">
            <p className="text-center">{t("waveOfRelaxation")}</p>
            <p className="text-center">{t("washOverYou")}</p>
            <p className="text-center">{t("hasDecided")}</p>
          </div>
        </div>
      </motion.div>
